...
// Update Party id of Candidate
app.put('/api/candidate/:id', (req, res) => {
    // check if party_id was provided
    ...
    const sql = `UPDATE candidates SET party_id = ?
                WHERE id = ?`;
    params = [req.body.party_id, req.params.id];
